...
void AdresatMenedzer::dodajAdresata()
{
    ...
    if(plikZAdresatami.dopiszAdresataDoPliku(adresat))
        cout<<"Nowy adresat zosta\210 dodany"<<endl;
    else
        cout<<"B\210\245d. Nie uda\210o si\251 doda\206 nowego adresata do pliku."<<endl;
    system("pause");
}
...
int AdresatMenedzer::usunAdresata()
{
    ...
    for (vector <Adresat>::iterator itr = adresaci.begin(); itr != adresaci.end(); itr++)
    {
        if (itr ->pobierzId()== idUsuwanegoAdresata)
        {
            ...
            cout<<"Odnaleziono poszukiwanego adresata: "<<endl;
            wyswietlDaneAdresata(*itr);
            cout<<"------------------------------------------------------"<<endl;
            cout << endl << "Potwierd\253 ch\251\206 usuni\251cia naciskaj\245c klawisz 't': ";
    ...
    for (int i = 0; i < adresaci.size(); i++)
    {
        if (adresaci[i].pobierzId() == idEdytowanegoAdresata)
        {
            ...
            case '5':
                ...
                break;
            case '6':
                cout << endl << "Powr\242t do menu u\276ytkownika" << endl << endl;
                break;
            default:
                cout << endl << "Nie ma takiej opcji w menu! Powr\242t do menu u\276ytkownika." << endl << endl;
                break;
            }
        }
    }
...
void AdresatMenedzer::wyszukajAdresatowPoImieniu()
{
    ...
    if (!adresaci.empty())
    {
        cout << ">>> WYSZUKIWANIE ADRESAT\340W PO IMIENIU <<<" << endl << endl;

        cout << "Wyszukaj adresat\242w po imieniu: ";
...
void AdresatMenedzer::wyszukajAdresatowPoNazwisku()
{
    ...
    if (!adresaci.empty())
    {
        cout << ">>> WYSZUKIWANIE ADRESAT\340W O NAZWISKU <<<" << endl << endl;

        cout << "Wyszukaj adresat\242w po nazwisku: ";
